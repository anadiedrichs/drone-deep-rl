...
class DroneOpenAIGymEnvironment(Supervisor, gym.Env):
    ...
    def __init__(self, max_episode_steps=1000):
       ...
       # error: we need an extra argument for that constructor
    ...
    def get_observations(self):
        ...
        arr = [roll, pitch, yaw_rate, v_x, v_y, self.altitude, range_front_value, range_back_value, range_right_value,
               range_left_value]
