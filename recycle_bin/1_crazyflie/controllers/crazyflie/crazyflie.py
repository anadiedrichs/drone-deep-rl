...
if __name__ == '__main__':
 ...
 #       camera_data = camera.getImage()
        ...
        print(" yaw " + str(yaw_desired) )        
        print(" height " + str(height_desired) ) 
        ...
        print(" m1 " + str(-motor_power[0]) )
        print(" m2 " + str(motor_power[1]) )
        print(" m3 " + str(-motor_power[2]) )        
        print(" m4 " + str(motor_power[3]) ) 
        past_time = robot.getTime()
