...
if __name__ == '__main__':
    ...
    toTarget = robot.getFromDef('cone_3')
    fromRobot = robot.getFromDef('crazyflie')

    if toTarget is None:
        print("ERROR !! TARGET or ROBOT are NONE")
        exit(-1)
